...
.e	tst.l	d0
	...
	st.b	7(a1,d1.w)	; update vector visibility
.next	swap	d6	
	dbf	d6,.xor
	dbf	d7,.loop
...
plot	move.l	doublebuffer(pc),a0
	lea	40*256*3(a0),a0
	addi.w	#320/2,d0
	addi.w	#256/2,d1
	move.b	d0,d2
...
alpha	dc.w	20	; z rotate angle
beta	dc.w	0	; x rotate angle
theta	dc.w	90	; y rotate angle
...
cube_vectors
	...
	dc.w	0,1,0,0		; [p1][p2][colour][visibility]
	dc.w	1,2,0,0
	dc.w	2,3,0,0
	dc.w	3,0,0,0
